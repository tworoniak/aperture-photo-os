...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "z-10 flex cursor-default items-center justify-center bg-white dark:bg-zinc-950 py-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
